...
As we get further along in using R, we will want to share our work
with others. This can be hard, as the installation of R on our laptops 
is not going to match another person's computer.
...
```{r, eval=F, echo=TRUE }
# Subfolder. Do not start the path with a slash.
